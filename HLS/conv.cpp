...
static float IN35[16][14][14] = { 0 };
static float POOL_24[16][14][14];
static float OUT13[16][28][28] = { 0 };

static float OUT567[120] = { 0 };
static float IN67[120] = { 0 };

#define parrell_num_3layer 4
static float W1[6][5][5] = { 0 };
static float W35[parrell_num_3layer][8][5][5] = { 0 };
...
void lenet(float* In_DRAM, float* W_DRAM, float* Out_DRAM, float* Bias_DRAM, int8_t layer)
{
	//AXI接口定义
